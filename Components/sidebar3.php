...
<nav id="sidebar3" class=" transition-all duration-500  z-[100]">
    ...
    <ul class="menu rounded-box w-full">
        ...
        <li class="flex items-center  user-profile">
            <a>
                <img class="pro border-color" src="<?= $youData['profile_image'] ?>"
                    class="w-16 h-16 rounded-full border-color border-2 shrink-0" />
                <div class="ml-4">
                    <h1 class="text-2xl whitespace-nowrap"><?= $youData['name'] ?></h1>
                    <p class="text-xs whitespace-nowrap text-muted"><?= $youData['email'] ?></p>
                </div>
            </a>
        </li>
